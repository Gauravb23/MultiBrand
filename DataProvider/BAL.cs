...
namespace DataProvider
{
    public class BAL
    {
        ...
        public DataSet HR_AffixationAndEmbosing(string vechileRegNo, int StateId)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("HR_AffixationAndEmbosing", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@VechileRegNo", vechileRegNo)).Direction = ParameterDirection.Input;
                cmd.Parameters.Add(new SqlParameter("@StateId", 9)).Direction = ParameterDirection.Input;
                SqlParameter ReturnValue = new SqlParameter("@ReturnValue", SqlDbType.VarChar, 300) { Direction = ParameterDirection.Output };
                ...
                if (ReturnValue.Value != "")
                {
                    ...
                    DataColumn Col = new DataColumn("Result");
                    DataRow Row = dtResult.NewRow();
                    dtResult.Columns.Add(Col);
                    Row[0] = ReturnValue.Value;
       ...
       string StringRearPlatePrize, string StringStickerPrize, string StringScrewPrize, ref int isexists)
        ...
        //-------------------------Add by Vimal two Method-------------

        public void SaveBankTranctionDealer(List<string> lst, out string strResult)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("[Transaction_SaveBankTransactiondealer]", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                cmd.Parameters.Add(new SqlParameter("@depodealerid", lst[12]));

                //-------Start-SGST-------
                cmd.Parameters.Add(new SqlParameter("@gstbasic", lst[13]));
                cmd.Parameters.Add(new SqlParameter("@sgstAmount", lst[14]));
                cmd.Parameters.Add(new SqlParameter("@CgstAmount", lst[15]));
                //-------End-SGST-------
                cmd.Parameters.Add(new SqlParameter("@tranctionMode", lst[16]));

                // cmd.Parameters.Add(new SqlParameter("@ChecqNo", lst[12]));
        ...
        public void SaveBankTranctionwithUser(List<string> lst, out string strResult)
        {
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@ChequeDate", DateTime.Parse(lst[13])));
                cmd.Parameters.Add(new SqlParameter("@chq_no", (lst[14])));
                cmd.Parameters.Add(new SqlParameter("@chq_BankName", (lst[15])));
                SqlParameter objSQLParm = new SqlParameter("@Result", SqlDbType.VarChar, 100);
                objSQLParm.Direction = ParameterDirection.Output;
                cmd.Parameters.Add(objSQLParm);
        ...
        public int UpdateBankTranctionDetails(List<string> lst)
        {
            int i = 0;
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("[Transaction_UpdateBankTransaction]", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@depositeDate", DateTime.Parse(lst[0])));    
                cmd.Parameters.Add(new SqlParameter("@EntryDate", DateTime.Parse(lst[1])));
                cmd.Parameters.Add(new SqlParameter("@BankName", lst[2]));
                cmd.Parameters.Add(new SqlParameter("@BranchName", lst[3]));
                cmd.Parameters.Add(new SqlParameter("@DepositAmount",(lst[4])));
                cmd.Parameters.Add(new SqlParameter("@DepositBy", lst[5]));
                //cmd.Parameters.Add(new SqlParameter("@StateID", lst[6]));
                //cmd.Parameters.Add(new SqlParameter("@RTOLocation", lst[7]));
                //cmd.Parameters.Add(new SqlParameter("@UserID", lst[8]));                    
                cmd.Parameters.Add(new SqlParameter("@BankSlipNo", lst[6]));
                cmd.Parameters.Add(new SqlParameter("@Remarks", lst[7]));
                cmd.Parameters.Add(new SqlParameter("@AccountNo", lst[8]));
                cmd.Parameters.Add(new SqlParameter("@TransactionID", lst[9]));
                cmd.Parameters.Add(new SqlParameter("@depolocationid", lst[10]));
                cmd.Parameters.Add(new SqlParameter("@oldTransactionID", lst[11]));
                cmd.Parameters.Add(new SqlParameter("@Approvedby", lst[12]));
                cmd.Parameters.Add(new SqlParameter("@rtolocationid", lst[13])); 
                con.Open();
                i = cmd.ExecuteNonQuery();
                con.Close();
                return i;
        ...
        public int BankTransactionlogcrete(List<string> lst)
        {
            int i = 0;
            using (SqlConnection con = new SqlConnection(ConnectionString))
            {
                try
                {
	             ...
	             SqlCommand cmd = new SqlCommand("[Create_BankTransaction_Log]", con);
                 cmd.CommandType = CommandType.StoredProcedure;
                    
                cmd.Parameters.Add(new SqlParameter("@TransactionID",lst[0]));        
    
                cmd.Parameters.Add(new SqlParameter("@PreviousBankName",lst[1]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedBankName", lst[2]));
                cmd.Parameters.Add(new SqlParameter("@PreviousBranchName", lst[3]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedBranchName",(lst[4])));
                cmd.Parameters.Add(new SqlParameter("@PreviousDepositAmount", lst[5]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedDepositAmount", lst[6]));
                cmd.Parameters.Add(new SqlParameter("@PreviousDepositBy", lst[7]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedDepositBy", lst[8]));                  
                cmd.Parameters.Add(new SqlParameter("@StateID", lst[9]));
                cmd.Parameters.Add(new SqlParameter("@previousRTOLocation", lst[10]));
                cmd.Parameters.Add(new SqlParameter("@UserID", lst[11]));
                cmd.Parameters.Add(new SqlParameter("@PreviousBankSlipNo", lst[12]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedBankSlipNo", lst[13]));
                cmd.Parameters.Add(new SqlParameter("@PreviousAccountNo", lst[14]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedAccountNo", lst[15]));  
                cmd.Parameters.Add(new SqlParameter("@Previousdepositelocationid", lst[16]));  
                cmd.Parameters.Add(new SqlParameter("@Updateddepositelocationid", lst[17]));  
                cmd.Parameters.Add(new SqlParameter("@PreviousApprovedBy", lst[18]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedApprovedBy", lst[19]));
                cmd.Parameters.Add(new SqlParameter("@previousDepositedate", lst[20]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedDepositedate", lst[21]));
                cmd.Parameters.Add(new SqlParameter("@PreviousEntrydate", lst[22]));
                cmd.Parameters.Add(new SqlParameter("@UpdatedEntrydate", lst[23]));
                cmd.Parameters.Add(new SqlParameter("@updateRTOLocation", lst[24]));
                    con.Open();
                    i = cmd.ExecuteNonQuery();
                    con.Close();
                    return i;
