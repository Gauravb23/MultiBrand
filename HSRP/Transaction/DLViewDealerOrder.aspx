                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <asp:ImageButton ID="ImageButton1" runat="server" AlternateText="ImageButton 1" TabIndex="2" ImageAlign="left" ImageUrl="../images/button/back.png" Style="height: 27px; width: 27px; margin-top: -4px;" OnClientClick="JavaScript: window.history.back(1); return false;" />&nbsp;&nbsp;View  Orders
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-lg-2 col-sm-2">
                                    ...
                                    <asp:ImageButton ID="btnExportExcel" runat="server" AlternateText="ImageButton 1" TabIndex="3" ImageAlign="Right" ImageUrl="../images/button/Download.jpg" Style="height: 24px; width: 69px;" OnClick="btnExportExcel_Click" OnClientClick="return validate()" />
                                    &nbsp;&nbsp;&nbsp;
                                     <asp:ImageButton ID="btnGO" runat="server" AlternateText="ImageButton 1" TabIndex="4" ImageAlign="Right" ImageUrl="../images/button/btngo.jpg" Style="height: 24px; width: 69px;" OnClick="btnGO_Click" OnClientClick="return validate()" />
                                </div>
                                ...
                                <asp:GridView ID="grdid" runat="server" align="center" CellPadding="4" ForeColor="#333333" GridLines="Both" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" Width="100%" AutoGenerateColumns="false">
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="OrderType" runat="server" Text='<%#Eval("hsrp_front_lasercode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="OrderType" runat="server" Text='<%#Eval("hsrp_rear_lasercode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
